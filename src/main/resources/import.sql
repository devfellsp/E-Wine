...
-- LIMPEZA DE DADOS
-- =========================
DELETE FROM vinho_uva;
DELETE FROM vinho;
DELETE FROM uva;
DELETE FROM tipovinho;
DELETE FROM safra;
DELETE FROM ocasiao;
DELETE FROM estilo;
DELETE FROM marca;
...
ALTER SEQUENCE marca_id_seq RESTART WITH 1;
ALTER SEQUENCE estilo_id_seq RESTART WITH 1;
ALTER SEQUENCE ocasiao_id_seq RESTART WITH 1;
ALTER SEQUENCE safra_id_seq RESTART WITH 1;
ALTER SEQUENCE tipovinho_id_seq RESTART WITH 1;
ALTER SEQUENCE uva_id_seq RESTART WITH 1;
ALTER SEQUENCE vinho_id_seq RESTART WITH 1;
...
-- =========================
-- ESTADOS (Bahia primeiro, pra passar no teste)
-- =========================
...
-- =========================
ALTER SEQUENCE pais_id_seq RESTART WITH 3;
ALTER SEQUENCE estado_id_seq RESTART WITH 4;
ALTER SEQUENCE cidade_id_seq RESTART WITH 4;
ALTER SEQUENCE marca_id_seq RESTART WITH 3;
ALTER SEQUENCE estilo_id_seq RESTART WITH 3;
ALTER SEQUENCE ocasiao_id_seq RESTART WITH 3;
ALTER SEQUENCE safra_id_seq RESTART WITH 3;
ALTER SEQUENCE tipovinho_id_seq RESTART WITH 3;
ALTER SEQUENCE uva_id_seq RESTART WITH 3;
ALTER SEQUENCE vinho_id_seq RESTART WITH 3;
